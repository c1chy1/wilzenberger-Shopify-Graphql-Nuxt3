import { defineNuxtModule, createResolver, isNuxt2, resolveModule, addPlugin, addAutoImport } from '@nuxt/kit';
...
const module = defineNuxtModule({
  ...
  setup(options, nuxt) {
    ...
    nuxt.options.alias.pinia = nuxt.options.alias.pinia || resolveModule("pinia/dist/pinia.mjs", {
