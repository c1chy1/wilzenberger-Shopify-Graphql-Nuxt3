var drawChart = (function (exports) {
  ...
  const Tooltip = ({ node, root, sizeProperty }) => {
      ...
      const content = T(() => {
          ...
          return (o$1(p$1, { children: [o$1("div", Object.assign({ className: "details-name" }, { children: node.data.name })), o$1("div", Object.assign({ className: "details-percentage" }, { children: percentageString })), availableSizeProperties.map((sizeProp) => {
                      if (sizeProp === sizeProperty) {
                          return (o$1("div", Object.assign({ className: "details-size" }, { children: o$1("b", { children: [LABELS[sizeProp], ": ", format_1(getModuleSize(node.data, sizeProp))] }) })));
                      }
                      else {
                          return (o$1("div", Object.assign({ className: "details-size" }, { children: [LABELS[sizeProp], ": ", format_1(getModuleSize(node.data, sizeProp))] })));
                      }
                  })] }));
  ...
  const Chart = ({ root, sizeProperty, selectedNode, setSelectedNode }) => {
      const [tooltipNode, setTooltipNode] = y(root);
