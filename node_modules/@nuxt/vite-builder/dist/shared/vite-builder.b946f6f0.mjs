...
import { resolve, join, dirname, relative, isAbsolute } from 'pathe';
import { logger, resolveModule, requireModule, resolvePath, isIgnored } from '@nuxt/kit';
import replace from '@rollup/plugin-replace';
import { resolve as resolve$1, findStaticImports, sanitizeFilePath } from 'mlly';
import { joinURL, withoutLeadingSlash, withTrailingSlash, withLeadingSlash, parseURL, parseQuery } from 'ufo';
...
function ssrStylesPlugin(options) {
  const cssMap = {};
  const idRefMap = {};
  const globalStyles = /* @__PURE__ */ new Set();
