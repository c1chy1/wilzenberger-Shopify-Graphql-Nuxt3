...
import require$$0$2, { existsSync, realpathSync, statSync, Stats } from 'fs';
import { pathToFileURL, fileURLToPath as fileURLToPath$1, URL as URL$1 } from 'url';
import { j as joinURL } from './nuxi.b6e8da95.mjs';
import { i as isAbsolute } from './nuxi.dae0d833.mjs';
...
function read(jsonPath) {
  return find(require$$0$1.dirname(jsonPath));
}
function find(dir) {
  try {
    const string = require$$0$2.readFileSync(
      require$$0$1.toNamespacedPath(require$$0$1.join(dir, "package.json")),
      "utf8"
    );
    return { string };
  } catch (error) {
    if (error.code === "ENOENT") {
      const parent = require$$0$1.dirname(dir);
      if (dir !== parent) {
        return find(parent);
      }
...
function defaultGetFormat(url) {
  ...
  if (parsed.protocol === "file:") {
    const ext = require$$0$1.extname(parsed.pathname);
    let format;
    if (ext === ".js") {
