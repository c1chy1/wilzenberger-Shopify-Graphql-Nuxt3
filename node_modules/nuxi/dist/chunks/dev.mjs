import { r as resolve, n as normalize, a as relative } from '../shared/nuxi.dae0d833.mjs';
...
import { w as withTrailingSlash } from '../shared/nuxi.b6e8da95.mjs';
import { s as setupDotenv } from '../shared/nuxi.4b822cbb.mjs';
import { a as showVersions, s as showBanner } from '../shared/nuxi.9ad14ec8.mjs';
import { w as writeTypes } from '../shared/nuxi.97ffc65c.mjs';
import { l as loadKit } from '../shared/nuxi.1b6f462d.mjs';
import { i as importModule } from '../shared/nuxi.77bdf71f.mjs';
import { o as overrideEnv } from '../shared/nuxi.6840794e.mjs';
import { l as loadNuxtManifest, w as writeNuxtManifest, c as cleanupNuxtDirs } from '../shared/nuxi.3c451c7f.mjs';
...
import 'node:module';
import 'node:url';
import '../shared/nuxi.6a4d1e8c.mjs';
...
var binaryExtensions$2 = {exports: {}};
...
const path = require$$0;
const binaryExtensions = binaryExtensions$2.exports;
...
const dev = defineNuxtCommand({
  ...
  async invoke(args) {
    ...
    watcher.on("all", (event, _file) => {
      ...
      const reloadDirs = [currentNuxt.options.dir.pages, "components", "composables"].map((d) => resolve(currentNuxt.options.srcDir, d));
      if (isDirChange) {
