...
import { p as pathKey, s as signalExit, m as mergeStream$1, g as getStream$1, c as crossSpawn$1 } from '../shared/nuxi.a2077a15.mjs';
...
Object.defineProperty(signals,"__esModule",{value:true});signals.getSignals=void 0;var _os$1=os$2;
...
Object.defineProperty(main,"__esModule",{value:true});main.signalsByNumber=main.signalsByName=void 0;var _os=os$2;
...
const clipboard$4 = {
	copy: async options => {
		try {
			await execa$1.exports('termux-clipboard-set', options);
		} catch (error) {
			handler(error);
		}
	},
	paste: async options => {
		try {
			const {stdout} = await execa$1.exports('termux-clipboard-get', options);
			return stdout;
		} catch (error) {
			handler(error);
		}
	...
	copySync: options => {
		try {
			execa$1.exports.sync('termux-clipboard-set', options);
		} catch (error) {
			handler(error);
		}
	},
	pasteSync: options => {
		try {
			return execa$1.exports.sync('termux-clipboard-get', options).stdout;
		} catch (error) {
			handler(error);
		}
	},
...
const xselWithFallback = async (argumentList, options) => {
	try {
		const {stdout} = await execa$1.exports(xsel, argumentList, options);
		return stdout;
	} catch (xselError) {
		try {
			const {stdout} = await execa$1.exports(xselFallback, argumentList, options);
			return stdout;
		} catch (fallbackError) {
...
const xselWithFallbackSync = (argumentList, options) => {
	try {
		return execa$1.exports.sync(xsel, argumentList, options).stdout;
	} catch (xselError) {
		try {
			return execa$1.exports.sync(xselFallback, argumentList, options).stdout;
		} catch (fallbackError) {
			throw makeError(xselError, fallbackError);
		}
	}
...
const clipboard$2 = {
	copy: async options => execa$1.exports('pbcopy', {...options, env}),
	paste: async options => {
		const {stdout} = await execa$1.exports('pbpaste', {...options, env});
		return stdout;
	},
	copySync: options => execa$1.exports.sync('pbcopy', {...options, env}),
	pasteSync: options => execa$1.exports.sync('pbpaste', {...options, env}).stdout,
};
...
const clipboard$1 = {
	copy: async options => execa$1.exports(windowBinaryPath, ['--copy'], options),
	paste: async options => {
		const {stdout} = await execa$1.exports(windowBinaryPath, ['--paste'], options);
		return stdout;
	},
	copySync: options => execa$1.exports.sync(windowBinaryPath, ['--copy'], options),
	pasteSync: options => execa$1.exports.sync(windowBinaryPath, ['--paste'], options).stdout,
};
