...
<template>
  ...
  <div>
    ...
    <select
      :id="id"
      class="block text-xs  p-1   pr-12  2xl:pr-16 sm:text-md xl:text-base text-gray-900 bg-white border border-gray-300 rounded-lg appearance-none focus:ring-indigo-600 focus:border-indigo-600"
      :class="[
        size === 'xs' ? 'p-1' :
        size === 'sm' ? 'p-2' :
        size === 'md' ? 'p-2.5' :
