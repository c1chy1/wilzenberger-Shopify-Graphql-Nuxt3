...
<footer
  ...
  >
    ...
    <nuxt-img src="/images/home_wilzenberger-bg-footer.png"
              loading="lazy"
              format="webp"
              quality="75"
              class="object-cover absolute w-full h-1/3 "

    >
    </nuxt-img>
  <div class="xl:w-2/3 grid grid-cols-2 sm:grid-cols-4 xl:p-4 items-center justify-items-center mx-auto divide-x-2 sticky">
...
<div class="w-full border-t-2 sticky">
